...
import com.maven.curso.entities.Payment;
import com.maven.curso.entities.Product;
...
import com.maven.curso.repositories.OrderItemRepository;
import com.maven.curso.repositories.OrderRepository;
import com.maven.curso.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1); //associando pedido com pagamento
